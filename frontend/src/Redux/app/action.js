...
axios.get("https://hotel-kp84.onrender.com/auths", params)
...
export const deleteItem = (id, payload) => (dispatch) => {
    ...
    return axios.delete(`https://hotel-kp84.onrender.com/auths/${id}`, payload)
  ...
  export const EditData = (id, payload) => (dispatch) => {
    ...
    return axios.patch(`https://hotel-kp84.onrender.com/auths/${id}`, payload)
