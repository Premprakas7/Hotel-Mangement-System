...
axios.get("https://hotel-m.onrender.com/data", params)
...
export const deleteItem = (id, payload) => (dispatch) => {
    ...
    return axios.delete(`https://hotel-m.onrender.com/data/${id}`, payload)
  ...
  export const EditData = (id, payload) => (dispatch) => {
    ...
    return axios.patch(`https://hotel-m.onrender.com/data/${id}`, payload)
